...
export const products: Product[] = [
  {
    ...
    description:
      "The snack that started it all. Coco Cado Original Crunch potato sticks — halal-certified, no preservatives, perfectly salted for a satisfying everyday crunch.",
    longDescription:
  ...
  },
  {
    ...
    category: "Potato Sticks",
    description:
      "Five packs, endless crunch. Coco Cado Party Bundle potato sticks are halal-certified and perfect for sharing at gatherings, parties, or family snack time.",
    longDescription:
    ...
    mainImage: "/ProductCover/20x5.png",
  ...
  },
  {
    ...
    category: "Potato Sticks",
    description:
      "For the seriously hungry snacker. Coco Cado Big Crunch Energy 43g potato sticks — bigger bag, bolder flavours, halal-certified with no preservatives or artificial colouring.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Coco Cado Pearl Bundle — 50g x 12pcs of halal popping pearls in Barley, Red Bean, and Water Chestnut. Juicy, fun, and perfect for retail display or gifting.",
    longDescription:
  ...
  },
  {
    ...
    category: "Popping Pearl",
    description:
      "The ultimate party-size snack. Coco Cado Event Pail 500g of halal popping pearls — ideal for weddings, corporate events, and large gatherings across Malaysia.",
    longDescription:
